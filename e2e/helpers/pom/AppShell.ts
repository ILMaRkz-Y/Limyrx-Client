...
export class AppShell {
  ...
  versionInput(loader: 'minecraft' | 'fabric' | 'forge' | 'neoforge' | 'quilt' | 'limyrx'): Locator {
    return this.main
  ...
  /** The loader selection card (vanilla / fabric / forge / neoforge / quilt / limyrx) in AddInstance. */
