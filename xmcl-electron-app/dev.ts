...
function reloadElectron() {
  ...
  // Don't restart if the process started less than 8 seconds ago
  if (electronProcess && Date.now() - electronStartTime < 8000) {
    return
  }
...
const debouncedReloadElectron = debounce(reloadElectron, 5000)
