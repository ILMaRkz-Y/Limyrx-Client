<template>
  <div class="store-entry h-full w-full overflow-hidden flex flex-col">
    ...
    <div class="flex-1 flex overflow-y-auto flex-col lg:(overflow-hidden flex-row)">
      ...
      <div
        class="filter-sidebar w-auto lg:(w-88 overflow-y-auto pb-20) flex-none px-4 pt-4 flex flex-col gap-6 custom-scrollbar"
      >
      ...
      <!-- Main Content -->
      <div class="store-content flex-1 lg:(overflow-y-auto) p-8 custom-scrollbar relative" ref="container">
        <!-- Featured Carousel -->
