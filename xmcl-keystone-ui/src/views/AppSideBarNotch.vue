    ...
    >
      ...
      >
        ...
        <AppSideBarNotchItem
          ...
          icon="home"
          :icon-size="iconSize"
          :tooltip="() => ({ text: t('dashboard.home'), direction: tooltipDirection })"
          to="/home"
        />
        ...
        <AppSideBarNotchItem
          ...
          icon="library_books"
          :icon-size="iconSize"
          :tooltip="() => ({ text: t('library.title'), direction: tooltipDirection })"
          to="/library"
        />
        ...
        <AppSideBarNotchItem
          ...
          icon="dns"
          :icon-size="iconSize"
          :tooltip="() => ({ text: t('servers.title'), direction: tooltipDirection })"
          clickable
          @click="goServers"
        />
        ...
        <AppSideBarNotchItem
          ...
          :icon-size="iconSize"
          :tooltip="() => ({ text: 'Admin Panel', direction: tooltipDirection })"
          to="/admin"
        >
          <v-icon class="sidebar-notch-item__icon" :size="iconSize" color="error">admin_panel_settings</v-icon>
        </AppSideBarNotchItem>
        ...
        <a
          ...
          class="sidebar-notch-link"
          v-shared-tooltip.right="() => ({ text: 'limyrx.xyz', direction: tooltipDirection })"
        >
          <v-icon size="16" color="rgba(255,255,255,0.3)">language</v-icon>
        </a>
      </div>
    </div>
  </div>
...
.sidebar-notch-link:hover {
  color: rgba(255, 255, 255, 0.7);
  background-color: rgba(255, 255, 255, 0.06);
}

.sidebar-notch--vertical .sidebar-notch-link {
  justify-content: center;
  padding: 6px 0;
}

.sidebar-notch--horizontal .sidebar-notch-link {
  width: auto;
  padding: 0 10px;
  height: 100%;
}
