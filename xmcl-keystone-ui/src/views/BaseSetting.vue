<template>
  <div class="base-setting px-10 py-6 overflow-auto" ref="root" @wheel.stop>
    ...
    <template v-else-if="targetQuery === 'files'">
      <BaseSettingInstanceFiles />
    </template>
    <template v-else-if="targetQuery === 'mods'">
      <BaseSettingInstanceMods />
    </template>
    <v-snackbar
...
import BaseSettingInstanceFiles from './BaseSettingInstanceFiles.vue'
import BaseSettingInstanceMods from './BaseSettingInstanceMods.vue'
