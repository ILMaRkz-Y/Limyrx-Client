<template>
  <div class="relative sidebar-instance-wrapper">
    ...
    <div
      v-if="isLocked"
      class="absolute -bottom-1 right-1 w-4 h-4 bg-gradient-to-br from-orange-500 to-red-500 rounded-full flex items-center justify-center shadow-md z-20 pointer-events-none"
    >
      <v-icon color="white" :size="10">
        lock
      </v-icon>
