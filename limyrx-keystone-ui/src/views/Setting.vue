...
/* Sidebar nav card — glass override */
.setting-sidebar .surface-card-subsection {
...
:root.dark .setting-sidebar .surface-card-subsection,
.dark .setting-sidebar .surface-card-subsection {
...
:root.dark .sticky-tabs-wrapper,
.dark .sticky-tabs-wrapper {
