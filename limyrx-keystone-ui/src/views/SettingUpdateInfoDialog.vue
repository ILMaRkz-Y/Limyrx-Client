<template>
  ...
  >
    ...
    <v-card
      ...
      style="width: 100%"
      to="https://github.com/ILMaRkz-Y/Limyrx-Client/releases"
      target="browser"
      push
    >
...
const openOfficialWebsite = () => {
  window.open('https://client.limyrx.online', 'browser')
}
const openGithub = () => {
  window.open('https://github.com/ILMaRkz-Y/Limyrx-Client/releases', 'browser')
}
</script>
