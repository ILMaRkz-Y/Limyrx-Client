<template>
  <div>
    ...
    <!-- Zoom / Display Scale -->
    <SettingCard class="mb-4" title="Zoom & Display" icon="zoom_in">
      <SettingItem
        :title="'UI Scale'"
        :description="'Adjust the zoom level of the entire launcher interface'"
      >
        <template #action>
          <div class="zoom-control">
            <v-btn
              ...
              size="small"
              variant="text"
              @click="uiZoom = Math.max(50, uiZoom - 5)"
            >
            ...
            <v-btn
              ...
              size="small"
              variant="text"
              @click="uiZoom = Math.min(150, uiZoom + 5)"
            >
              <v-icon>add</v-icon>
            </v-btn>
            <v-btn
...
// UI Zoom control — stored in localStorage, applied reactively by App.vue
...
/* Fix slider track and thumb visibility */
.zoom-slider :deep(.v-slider-track__background) {
  background: rgba(255, 255, 255, 0.15) !important;
  opacity: 1 !important;
}

.zoom-slider :deep(.v-slider-track__background-fill) {
  background: rgb(var(--v-theme-primary)) !important;
  opacity: 1 !important;
}

:root.dark .zoom-slider :deep(.v-slider-track__background),
.dark .zoom-slider :deep(.v-slider-track__background) {
  background: rgba(255, 255, 255, 0.12) !important;
}

.zoom-slider :deep(.v-slider-thumb) {
  cursor: grab;
}

.zoom-slider :deep(.v-slider-thumb:active) {
  cursor: grabbing;
}

.zoom-slider :deep(.v-slider-thumb__label) {
  background: rgb(var(--v-theme-primary)) !important;
