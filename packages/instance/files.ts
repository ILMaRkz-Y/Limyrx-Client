 ...
 *
 * Extended to support admin metadata (name, icon, banner) and system file tracking.
 */
export const InstanceManifest = InstanceDataFieldsSchema.partial().extend({
  ...
  files: z.array(InstanceFile),
  /** Admin-overridable instance name */
  name: z.string().optional(),
  /** Admin-overridable instance icon (URL or data URI) */
  icon: z.string().optional(),
  /** Admin-overridable instance banner image URL */
  banner: z.string().optional(),
  /** Description override from admin */
  description: z.string().optional(),
  /** List of system file entries to track as protected */
